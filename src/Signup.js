...
const Signup = ()=>{
    return(
        <div className='bg-indigo-100 '>
            <div className='container px-5 mx-auto py-12 flex flex-col items-center gap-6 sm:w-[40%]'>
                ...
                <div className='flex flex-col items-center gap-2'>
                    <h1 className='text-3xl font-semibold'>Sign Up Request</h1>
                    <h3 className='text-xl text-gray-400'>Submit your sign up request and we will reach back asap.</h3>
                </div>
        ...
        <div>
        <h3 className='text-xl text-indigo-300 flex items-center justify-center'><span className='mr-2'>Already have an account?</span> <Link to="/signin">Log In</Link>   </h3>
